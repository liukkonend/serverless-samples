...
describe('Test locations handler', () => { 
    ...
    it('should return single location for valid ID', async () => { 
        ...
        // Invoke Express route
        const response = await request(app).get('/f8216640-91a2-11eb-8ab9-57aa454facef');
    ...
    it('should return 404', async () => { 
        ...
        // Invoke Express route
        const response = await request(app).get('/fd6cdda0-917a-11eb-9054-67837e2c40b0');
    ...
    it('should delete location by ID', async () => { 
        ...
        // Invoke Express route
        const response = await request(app).delete('/1ec9b8a0-9244-11eb-ab60-99d5acd6d148');
